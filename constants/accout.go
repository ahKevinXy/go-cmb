...
const (
	...
	CmbUnitManageCloseAccountV2             = "NTDUMDLT"    //关闭记账子单元NTDUMDLT
	CmbUnitManageAccountQueryV2             = "NTDUMQRY"    //记账子单元查询NTDUMQRY
	CmbUnitManageAccountQueryV1             = "NTDMABAL"    //记账子单元查询NTDUMQRY
