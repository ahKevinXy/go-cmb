...
func MainAccountInfo(userId, sm4Key, userPrivateKey, accnbr, bbknbr string) (*models.AccountInfoResponse, error) {
	...
	//  todo 优化
	res := help.CmbSignRequest(string(req), constants.CmbAccountInfo, userId, userPrivateKey, sm4Key)
...
func MainAccountHistoryBalance(
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbAccountHistoryBalance, userId, userPrivateKey, sm4Key)
...
func GetBankLinkNo(userId, sm4Key, userPrivateKey, accnbr string) (*models.AccountBankInfoResponse, error) {
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbAccountQueryBankLinkNo, userId, userPrivateKey, sm4Key)
...
func GetMainAccountPayBusList(userId, sm4Key, userPrivateKey, buscode string) (*models.QueryAccountTransCodeResponse, error) {
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbAccountPayModQuery, userId, userPrivateKey, sm4Key)
...
func QueryBatchAccountBalance(userId, sm4Key, userPrivateKey, accnbr, bbknbr string) (*models.QueryBatchAccountBalanceResponse, error) {
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbAccountBatchQueryBalance, userId, userPrivateKey, sm4Key)
