...
func PayMods(userId, sm4Key, userPrivateKey, busCode string) (*models.QueryAccountTransCodeResponse, error) {
	...
	res := help.CmbSignRequest(string(req), constants.CmbAccountCanPayMod, userId, userPrivateKey, sm4Key)
