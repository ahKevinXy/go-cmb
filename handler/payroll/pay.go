...
func UnitPayrollPayment(userId, sm4PrivateKey, userPrivateKey string, payMod []*models.Bb6Busmod, totalInfo []*models.Bb6cdcbhx1, payList []*models.Bb6cdcbhx1) (*models.UnitPayrollPaymentResponse, error) {
	...
	reqData.Request.Body.Bb6cdcbhx1 = payList
