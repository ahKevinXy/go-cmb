...
func QueryBatchTransInfo(userId, sm4Key, userPrivateKey, buscode, yurref, bthnbr, trxseq, histga string) (*models.QueryBatchTransInfoResponse, error) {
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbPayrollQuery, userId, userPrivateKey, sm4Key)
...
func QueryBatchTransList(userId, sm4Key, userPrivateKey, buscode, yurref, bgndat, enddat, cntkey, dattyp string) (*models.QueryBatchTransListResponse, error) {
...
func QueryPayrollTransDetail(userId, sm4Key, userPrivateKey, reqnbr, bthnbr, trxseq, histag string) (*models.QueryPayrollTransDetailResponse, error) {
	...
	//  todo
	res := help.CmbSignRequest(string(req), constants.CmbPayrollQueryDetail, userId, userPrivateKey, sm4Key)
